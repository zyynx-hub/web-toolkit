  ...
  return (
    <div style={{ position: "relative", marginLeft: 20, marginRight: 20 }}>
      ...
      >
        ...
        <span style={{ fontFamily: "var(--font-heading)", fontSize: 17, fontWeight: 700, color: "var(--text)" }}>{data.rating}</span>
        <StarRating rating={data.rating} size={12} />
        <span style={{ fontSize: 12, color: "var(--text-muted)" }}>({data.reviewCount})</span>
        <motion.span
        ...
        <div className="s-container" style={{ paddingTop: "clamp(3rem, 6vw, 5rem)", paddingBottom: "clamp(3rem, 6vw, 5rem)" }}>
          ...
          <Reveal delay={0.45}>
            <div style={{ display: "flex", flexWrap: "wrap", alignItems: "stretch", gap: 20, marginTop: 48 }}>
              ...
              {/* Google Reviews stat — matches other stats */}
              <div style={{
                display: "flex",
                flexDirection: "column",
                justifyContent: "center",
