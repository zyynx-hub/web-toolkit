...
function GoogleReviewsWidget({ reviews: data }: {
  ...
  return (
    <div style={{ position: "relative" }}>
      {/* Stat-style trigger — matches 15+ and 5000+ */}
      <button
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
          <span style={{ fontFamily: "var(--font-heading)", fontSize: "clamp(1.5rem, 3vw, 2rem)", color: "var(--text)", fontWeight: 600 }}>{data.rating}</span>
