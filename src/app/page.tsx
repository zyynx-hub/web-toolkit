...
function FloatingOrbs() {
  const orbs = [
    { size: 5, x: "15%", y: "25%", delay: 0, dur: 7, color: "rgba(251,146,60,0.3)" },
    { size: 3, x: "75%", y: "35%", delay: 1, dur: 9, color: "rgba(234,179,8,0.25)" },
    { size: 4, x: "55%", y: "70%", delay: 3, dur: 8, color: "rgba(251,146,60,0.2)" },
    { size: 3, x: "85%", y: "60%", delay: 2, dur: 11, color: "rgba(234,179,8,0.2)" },
    { size: 4, x: "30%", y: "80%", delay: 4, dur: 10, color: "rgba(251,146,60,0.2)" },
    { size: 6, x: "45%", y: "20%", delay: 1, dur: 12, color: "rgba(234,179,8,0.15)" },
  ]
  return (
    <>
      {orbs.map((o, i) => (
    ...
    >
      <Link href={project.slug}>
        <motion.div
          ...
          style={{ rotateX, rotateY, transformPerspective: 1200, borderColor: "rgba(0,0,0,0.06)" }}
...
function FilterTabs({ active, onChange }: { active: Category; onChange: (c: Category) => void }) {
  return (
    <div className="flex items-center gap-1 p-1 rounded-full" style={{ background: "rgba(0,0,0,0.03)", border: "1px solid rgba(0,0,0,0.05)" }}>
      {categories.map((cat) => (
        <motion.button
          key={cat}
      ...
      <header className="relative min-h-screen flex flex-col items-center justify-center px-6 overflow-hidden">
        ...
        >
          ...
          <div className="flex items-center gap-6">
            <a href="mailto:zyynx1@hotmail.com" onClick={(e) => { setTimeout(() => { window.open('https://outlook.live.com/mail/0/deeplink/compose?to=zyynx1@hotmail.com', '_blank') }, 500); }} className="transition-colors" style={{ color: "rgba(0,0,0,0.25)" }}>
              <Mail size={18} />
            </a>
          </div>
        </motion.div>
        ...
        <div className="text-center relative z-10">
          ...
          >
            ...
            <motion.a
              href="mailto:zyynx1@hotmail.com" onClick={(e) => { setTimeout(() => { window.open('https://outlook.live.com/mail/0/deeplink/compose?to=zyynx1@hotmail.com', '_blank') }, 500); }}
